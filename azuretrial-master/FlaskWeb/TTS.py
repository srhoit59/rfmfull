...
#ser = pd.read_excel('Copy of DB-O.xlsx',sheet_name='TTSDB1-O',index_col=0)
for i in range(0,4):
...
data=BytesIO(data)
blobservice.create_blob_from_stream('ttscontainer','TTSINC.xlsx',data)
data.close()
"""
from pandas import ExcelWriter
if not os.path.exists('Generated-Excels'):
    os.makedirs('Generated-Excels')
writer = ExcelWriter('Generated-Excels/TTSINCR.xlsx')
