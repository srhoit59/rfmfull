...
byte_stream = BytesIO()
blobservice.get_blob_to_stream(container_name='htflaskcontainer', blob_name='ssedu.xlsx', stream=byte_stream)
byte_stream.seek(0)
...
data=BytesIO(data)
blobservice.create_blob_from_stream('ssecontainer','SSEINC.xlsx',data)
data.close()
"""
from pandas import ExcelWriter
if not os.path.exists('Generated-Excels'):
    os.makedirs('Generated-Excels')
writer = ExcelWriter('Generated-Excels/SSEINCR.xlsx')
